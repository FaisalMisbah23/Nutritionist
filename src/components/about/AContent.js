...
const AContent = () => {
  return (
    ...
    <div className="bg-indigo-10 flex flex-col text-center w-full px-6 py-10 sm:px-20">
    <h1 className="text-3xl text-center font-semibold mb-6 text-gray-900">Welcome to Nutritionist</h1>
    <p className="w-full">Your trusted source for personalized nutrition coaching. Our mission is to help you achieve your weight loss and health goals through tailored nutrition plans and expert guidance. We understand that every individual is unique, and that's why we believe in providing personalized solutions that fit your lifestyle and preferences.
